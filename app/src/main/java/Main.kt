...
class Main : Application() , LifecycleObserver {
    ...
    fun onAppBackgrounded() {
        ...
        sharedPreferencesService.writeToSharedPreferences(this@Main, shopService.getOrder(),"shop_order", Order::class.java)
    }

    @OnLifecycleEvent(Lifecycle.Event.ON_START)
    fun onAppForegrounded() {
        val order = sharedPreferencesService.loadFromSharedPreferences(this@Main, "shop_order", Order::class.java)
        if (order != null)
