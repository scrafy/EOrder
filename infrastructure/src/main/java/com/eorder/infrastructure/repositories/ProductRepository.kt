...
class ProductRepository(httpClient: IHttpClient) : BaseRepository(),
    ...
    override fun getProductsByCatalog(catalogId: Int): ServerResponse<List<Product>> {
        ...
        products.add(Product(2,21F,"IVA",0,89.52369F,"Juego de sartenes","Juego de dos sartenes","Menaje y cocina","https://www.lecreuset.es/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/s/e/set_sartenes.jpg"))
        ...
        products.add(Product(4,21F,"IVA",0,89.52369F,"Paquete pan de molde","Paquete pan de molde","Alimentacion","https://www.bimbo.es/uploads/productos/es/bimbo_rebanada_estilo_artesano_i.png"))
